...
namespace Batates.Data
{
    public static class SeedData
    {
        ...
        public static List<Restaurant> RestaurantList()
        {
            ...
            {
                // Italian
                new Restaurant() { ID = 1, Name = "RomaPizza", Description = "Our mission is to uphold the highest level of quality in all we do, from the quality and origin of our food to our care for the health of our customers and the environment.", State = State.Opened, ContactNo = "0114379314" },
                new Restaurant() { ID = 2, Name = "Taste of Italy", Description = "Experience the authentic flavors of Italy with our handcrafted pizzas, pasta, and mouthwatering desserts, served with a touch of Italian hospitality.", State = State.Opened, ContactNo = "0215896347" },
                new Restaurant() { ID = 3, Name = "El Taco Loco", Description = "Get ready for a fiesta of flavors with our bold and delicious Mexican cuisine, featuring tacos, burritos, and sizzling fajitas that will transport you south of the border.", State = State.Opened, ContactNo = "0317269854" },
                new Restaurant() { ID = 4, Name = "Sushi Zen", Description = "Discover the art of sushi at Sushi Zen, where our skilled chefs combine fresh ingredients with precision and technique to create sushi rolls that are as beautiful as they are delicious.", State = State.Opened, ContactNo = "0413785621" },
                new Restaurant() { ID = 5, Name = "Spice Route", Description = "Embark on a culinary journey through the flavors of India at Spice Route, where our aromatic spices and authentic recipes will tantalize your taste buds and transport you to the streets of Mumbai.", State = State.Opened, ContactNo = "0518932746" },

                new Restaurant() { ID = 6, Name = "Taco Tango", Description = "Dance your taste buds to the rhythm of Mexico with Taco Tango, where our bold flavors and festive atmosphere will spice up your dining experience.", State = State.Opened, ContactNo = "1112345678" },
                new Restaurant() { ID = 7, Name = "Burrito Bar", Description = "Wrap yourself in flavor with Burrito Bar, where our customizable burritos and fresh ingredients will satisfy your cravings for authentic Mexican cuisine.", State = State.Opened, ContactNo = "1212345678" },
                new Restaurant() { ID = 8, Name = "Fiesta Grill", Description = "Join the fiesta at Fiesta Grill, where our sizzling fajitas, flavorful tacos, and refreshing margaritas will transport you straight to the heart of Mexico.", State = State.Opened, ContactNo = "1312345678" },
                new Restaurant() { ID = 9, Name = "Cantina Caliente", Description = "Heat up your night at Cantina Caliente, where our spicy dishes and lively atmosphere will make every meal feel like a celebration.", State = State.Opened, ContactNo = "1412345678" },
                new Restaurant() { ID = 10, Name = "Salsa Street", Description = "Take a trip down Salsa Street for a taste of authentic Mexican street food, where our vibrant flavors and casual setting will keep you coming back for more.", State = State.Opened, ContactNo = "1512345678" },

                new Restaurant() { ID = 11, Name = "Sushi Supreme", Description = "Experience sushi perfection at Sushi Supreme, where our expert chefs use only the freshest ingredients to create sushi rolls that are as beautiful as they are delicious.", State = State.Opened, ContactNo = "1612345678" },
                new Restaurant() { ID = 12, Name = "Sakura Sushi Bar", Description = "Find your zen at Sakura Sushi Bar, where our serene ambiance and exquisite sushi creations will transport you to the tranquil gardens of Japan.", State = State.Opened, ContactNo = "1712345678" },
                new Restaurant() { ID = 13, Name = "Ninja Noodles", Description = "Unleash your inner ninja at Ninja Noodles, where our bold flavors and innovative noodle dishes will satisfy your cravings for authentic Japanese cuisine.", State = State.Opened, ContactNo = "1812345678" },
                new Restaurant() { ID = 14, Name = "Tokyo Teppanyaki", Description = "Experience the excitement of teppanyaki dining at Tokyo Teppanyaki, where our skilled chefs entertain and delight you with their culinary prowess.", State = State.Opened, ContactNo = "1912345678" },
                new Restaurant() { ID = 15, Name = "Wasabi Wonderland", Description = "Journey into the world of wasabi at Wasabi Wonderland, where our bold flavors and creative sushi rolls will awaken your senses and transport you to a land of culinary adventure.", State = State.Opened, ContactNo = "2012345678" },

                new Restaurant() { ID = 16, Name = "Curry Corner", Description = "Spice up your life at Curry Corner, where our aromatic curries and flavorful Indian dishes will take your taste buds on a journey to the vibrant streets of India.", State = State.Opened, ContactNo = "2112345678" },
                new Restaurant() { ID = 17, Name = "Tandoori Terrace", Description = "Experience the flavors of the tandoor at Tandoori Terrace, where our smoky grilled meats and tender breads will transport you to the bustling markets of Delhi.", State = State.Opened, ContactNo = "2212345678" },
                new Restaurant() { ID = 18, Name = "Biryani Bazaar", Description = "Savor the rich flavors of India with Biryani Bazaar, where our fragrant rice dishes and succulent meats are cooked to perfection and served with love.", State = State.Opened, ContactNo = "2312345678" },
                new Restaurant() { ID = 19, Name = "Masala Magic", Description = "Experience the magic of Indian spices at Masala Magic, where our flavorful curries, aromatic biryanis, and decadent desserts will transport you to the colorful streets of Mumbai.", State = State.Opened, ContactNo = "2412345678" },
                new Restaurant() { ID = 20, Name = "Naan Nirvana", Description = "Find your nirvana at Naan Nirvana, where our soft and fluffy naan breads and savory accompaniments will elevate your dining experience to new heights.", State = State.Opened, ContactNo = "2512345678" },
            };
